...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "next":
        ...
        if not batch:
            ...
            for k in batch:
                print(f"  [{k['id']}] [{k['intent']}] [{k['difficulty']}] {k['keyword']} -> {k['page_type']}")
